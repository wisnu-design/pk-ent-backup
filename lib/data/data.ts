...
export const services: Service[] = [
 {
  ...
  description: `At the forefront of Indonesia's live entertainment industry, bringing 25+ world-class concerts to life. As we near 1 million fans nationwide, we continue setting new benchmarks for unforgettable international music experiences.`,
...
Instagram:@pkentertainment.id`,
 ...
 },
 {
  id: 2,
  title: 'PK Events',
  description: 'PK Events has crafted more than 300 extraordinary experiences across Indonesia. From summits and CxO dinners to festivals, and award shows. Our expertise has been trusted by global leaders - reinforcing our role as the partner of choice for impactful brand and corporate events.',
...
In 2025, we are proud to be shortlisted at the Marketing Events Awards Singapore for Best Consumer Event, Best B2B Event, and Team of the Year.`,
 ...
 },
 {
  id: 3,
  title: 'PK Music',
  description: `Launched with the sold-out Shiela on 7 tour that drew 200,000+ fans, PK Music is redefining the live music experience for Indonesia's top artists. We are committed to elevating homegrown talent, celebrating cultural pride, and creating new stages for local musicians to shine.`,
...
Instagram:@pkmusic.id`,
    serviceUrl: '/revamp/music'
 },
 {
  id: 4,
  title: 'PK Films',
  description: 'PK Films produces world-class feature films that showcase creativity with cinematic excellence. Our mission is to bring powerful stories to the screen and connect them with audiences worldwide, positioning Indonesia as a vibrant and influential force in global cinema.',
